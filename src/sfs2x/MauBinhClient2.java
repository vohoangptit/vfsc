 ...
 * @author tuanp
 */
public class MauBinhClient2 implements IEventListener {
...
//    public int port = 9934;
    ...
    public String userName = "test23@mecorp.vn";
    ...
    public static void main(String[] args) {
        ...
        MauBinhClient2 client = new MauBinhClient2();
        client.start();
    }
...
//                skipBoard(room);
    ...
    private void processMessageInGame(ISFSObject data) {
        try {
            ...
            switch (action) {
                case MauBinhCommand.START:
                    log.info("START GAME:");
//                    leaveBoard();
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.STOP:
                    log.info("STop GAME:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.SEND_CARDS:
                    log.info("SEND_CARDS:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.DEC_SAP_HAM:
                    log.info("DEC_SAP_HAM:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.USER_MONEY_INFO:
                    log.info("USER_MONEY_INFO:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.INTERFACE_ERROR:
                    log.info("INTERFACE_ERROR:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.SET_LIMIT_TIME:
                    log.info("SET_LIMIT_TIME:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.TABLE_INFO:
                    log.info("TABLE_INFO:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.SORT_BY_ORDER:
                    log.info("SORT_BY_ORDER:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.SORT_BY_TYPE:
                    log.info("SORT_BY_TYPE:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.AUTO_ARRANGE:
                    log.info("AUTO_ARRANGE:");
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.FINISH:
                    ...
                    log.info(data.getDump());
                    break;
                case MauBinhCommand.INGAME_INFOR:
                    log.info("INGAME_INFOR:");
                    log.info(data.getDump());
                    break;
...
//                    this.leaveBoard();
    ...
    private void joinRoomBoard(){
        sfsClient.send( new JoinRoomRequest("MB_1000") );
    }
     /**
     * user leave a board
     */
